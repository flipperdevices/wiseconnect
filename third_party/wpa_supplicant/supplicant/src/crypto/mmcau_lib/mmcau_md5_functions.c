...
//
// FILE NAME      : mmcau_md5_functions.c
// VERSION        : $Id: mmcau_md5_functions.c.rca 1.3 Tue Apr 12 16:03:52 2011 rzsy20 Experimental $
...
const u32 md5_t[] = {0xd76aa478, 0xe8c7b756, 0x242070db, 0xc1bdceee,
...
u32 md5_rnd[] = {7, 12, 17, 22,  7, 12, 17, 22,
...
void mmcau_md5_initialize_output (u32 md_state[])
{
...
void mmcau_md5_hash_n (u32 msg_data[], int num_blks,
                       u32 md_state[])
...
void mmcau_md5_update (u32 msg_data[], int num_blks,
                       u32 md_state[])
{
