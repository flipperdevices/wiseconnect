 ...
 ******************************************************/
extern void rsi_wlan_app_send_to_ble(uint16_t msg_type, const uint8_t *data, uint16_t data_len);
 ...
 * This is a callback function
 */
void rsi_wlan_app_send_to_ble(uint16_t msg_type, const uint8_t *data, uint16_t data_len)
{
  ...
  memset(rsi_ble_app_data, 0, sizeof(rsi_ble_app_data));
